...
void printa_um(haste *pino, int linha){
		...
		switch(pino->vetor[linha]){
			...
			case 1:{
				printf("         %c         ", 219);//Disco branco
				break;
			}
			case 2:{
				printf("\033[1;31m");
				printf("        %c%c%c        ", 219, 219, 219);//Disco vermelho
				printf("\033[0m");
				break;
			}
			case 3:{
				printf("\033[1;32m");
				printf("       %c%c%c%c%c       ", 219, 219, 219, 219, 219);//Disco verde
				printf("\033[0m");
				break;
			}
			case 4:{
				printf("\033[1;33m");
				printf("      %c%c%c%c%c%c%c      ", 219, 219, 219, 219, 219, 219, 219);//Disco amarelo
				printf("\033[0m");
				break;
			}
			case 5:{
				printf("\033[1;34m");
				printf("     %c%c%c%c%c%c%c%c%c     ", 219, 219, 219, 219, 219, 219, 219, 219, 219);//Disco azul escuro
				printf("\033[0m");
				break;
			}
			case 6:{
				printf("\033[1;35m");
				printf("    %c%c%c%c%c%c%c%c%c%c%c    ", 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219);//Disco roxo
				printf("\033[0m");
				break;
			}
			case 7:{
				printf("\033[1;36m");
				printf("   %c%c%c%c%c%c%c%c%c%c%c%c%c   ", 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219);//Disco azul claro
				printf("\033[0m");
				break;
			}
			case 8:{
				printf("  %c%c%c%c%c%c%c%c%c%c%c%c%c%c%c  ", 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219);//Disco branco
				break;
			}
		}
		return;
